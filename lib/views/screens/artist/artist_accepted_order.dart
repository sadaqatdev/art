import 'package:art/controllers/artist_accepted_offer_controller.dart';
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                GetBuilder<ArtistAcceptedOffer>(
                    init: ArtistAcceptedOffer(),
                    builder: (controller) {
                      return Expanded(
...
//
                            ...
                            itemBuilder: (context, index) {
                              return NewTile(
                                  offer: controller.offer, index: index);
                            }),
                      );
                    }),
              ],
