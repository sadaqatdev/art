...
class AboutUs extends StatefulWidget {
  @override
  _AboutUstState createState() => _AboutUstState();
}

class _AboutUstState extends State<AboutUs> {
  @override
            ...
            Center(
              child: Container(
                ...
                child: Text('Lorem Ipsum is simply dummy text of the printing  and typesetting industry.'
                    ...
                    fontSize: height/60, fontWeight: FontWeight.w500, color: Colors.black, letterSpacing: 1.0, height: 1.5
                ),),
              ),
            )
          ],
